...
<head>
  ...
  <script scr="<?php echo e(asset('/js/ie-emulation-modes-warning.js')); ?>"></script>
...
<body>
  ...
  <script>window.jQuery || document.write('<script scr="<?php echo e(asset('/js/jquery.min.js')); ?>"><\/script>')</script>
  <script scr="<?php echo e(asset('/js/bootstrap.min.js')); ?>"></script>
  <script scr=" <?php echo e(asset('/js/ie10-viewport-bug-workaround.js')); ?>"></script>
